        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
          <div className="flex items-center space-x-6">
            <a
              ...
              className="text-foreground/60 hover:text-[#8c6623] transition-colors"
              aria-label="GitHub"
            >
              <svg
                className="h-5 w-5"
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center space-x-2 text-foreground/60 hover:text-[#8c6623] transition-colors"
